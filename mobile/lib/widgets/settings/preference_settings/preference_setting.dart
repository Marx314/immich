...
import 'package:immich_mobile/widgets/settings/preference_settings/default_album_filter_setting.dart';
...
class PreferenceSetting extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const preferenceSettings = [ThemeSetting(), HapticSetting(), DefaultAlbumFilterSetting()];
